...
{pstd}
This is version 2.0 of the XTEWreg command. Please send bug reports and feature requests to robert.parham@simon.rochester.edu. Adapted to Stata by Robert Parham, based on code provided by Toni M. Whited.
